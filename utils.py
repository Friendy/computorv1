...
def get_coef(input_data, pow_ind):
    ...
    coef  = float(input_data[start: end + 1])
...
def solution(arr, degree):
    if degree == 2:
        ...
        if D > 0:
            ...
            print("Discriminant is strictly positive, the two solutions are:", s1, s2, sep="\n")            
        elif D == 0:
            print("Discriminant equals zero, the solution is:", -arr[1]/2*arr[2])
        else:
