...
python $DIR/../computor_bonus.py "5 * X^0 + 4 * X^1 - 9.3 * X^2 = 1 * X^0"
print_input "5 * X^0 + 4 * X^1 = 4 * X^0"
python $DIR/../computor_bonus.py "5 * X^0 + 4 * X^1 = 4 * X^0"
print_input "8 * X^0 - 6 * X^1 + 0 * X^2 - 5.6 * X^3 = 3 * X^0"
python $DIR/../computor_bonus.py  "8 * X^0 - 6 * X^1 + 0 * X^2 - 5.6 * X^3 = 3 * X^0"
...
python $DIR/../computor_bonus.py "5 * X^0 + 4 * X^1 - 8 * X^2 = 1 * X^0"
print_input "5 * X^0 + 4 * X^1 - 15 * X^2 = 1 * X^0"
python $DIR/../computor_bonus.py "5 * X^0 + 4 * X^1 - 15 * X^2 = 1 * X^0"
...
python3 $DIR/../computor_bonus.py "- 1 * X^1 - 7 * X^2 = 6 * X^0"
# echo "*****ZERO TESTS*******"
