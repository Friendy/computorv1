...
run_code  "5 * X^0 +4 * X^1 - 8 * X^2 = 1 * X^0"
run_code "5 * X^0 + 4 * X^1 - 15 * X^2= 1 * X^0"
run_code "-5 * X^0 + 4 * X^1 - 15 * X^2 = 1 * X^0"
run_code "5 * X^0 + 4* X^1 - 15 * X^2 = 1 * X^0"
run_code "5 * X^0 + 4 * X^1 - 15 * X^2 = 1 *X^0"
run_code "- 5 * X^0 + 4 * X^1 - 15 * X^2 =1 * X^0"
...
run_code "5 * X^0 + 4 * 42^1 - 8 * X^2 = 1 * X^0"
run_code "42^1 - 8 * X^2 = 1 * X^0"
run_code "5 * X^ 0 + 4 * X^1 - 15 * X^2 = 1 * X^0"

print_group_name "forbidden symbols"
run_code "tet  tereyrywey=eyeyewyerwy"
run_code "tet  tereyryweyeyeyewy77erwy"
run_code "5 * X^0 + t * X^1 - 8 * X^2 = 1 * X^0"
run_code "^66 = 44"

print_group_name "coefficent format"
run_code "- 05 * X^0 + 4 * X^1 + 8 * X^2 = 1 * X^0"
run_code "- 5^ * X^0 + 4 * X^1 + 8 * X^2 = 1 * X^0"
run_code "- 5. * X^0 + 4 * X^1 + 8 * X^2 = 1 * X^0"
